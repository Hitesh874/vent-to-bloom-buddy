...
import { Calendar, TrendingUp, Heart, Brain, Smile, Frown, Meh, Angry, Zap, Leaf, Home } from 'lucide-react';
...
const Mood = () => {
  const [moodEntries] = useState<MoodEntry[]>([
    { id: '1', date: new Date('2024-06-10'), mood: 'anxious', intensity: 4, notes: 'Exam stress hitting hard', triggers: ['academic', 'future'] },
    { id: '2', date: new Date('2024-06-11'), mood: 'sad', intensity: 3, notes: 'Friend drama', triggers: ['social', 'relationships'] },
    { id: '3', date: new Date('2024-06-12'), mood: 'happy', intensity: 4, notes: 'Aced my presentation!', triggers: ['achievement', 'confidence'] },
    { id: '4', date: new Date('2024-06-13'), mood: 'neutral', intensity: 3, notes: 'Just vibing', triggers: ['routine'] },
    { id: '5', date: new Date('2024-06-14'), mood: 'happy', intensity: 5, notes: 'Best day ever! Got accepted to internship', triggers: ['achievement', 'future'] },
  ]);
  ...
  const getMoodIcon = (mood: string, size: string = 'w-6 h-6') => {
    switch (mood) {
      case 'happy': return <Smile className={`${size} text-yellow-500`} />;
      case 'sad': return <Frown className={`${size} text-blue-500`} />;
      case 'anxious': return <Zap className={`${size} text-purple-500`} />;
      case 'angry': return <Angry className={`${size} text-red-500`} />;
      default: return <Meh className={`${size} text-gray-500`} />;
    }
  };
  ...
  const averageIntensity = moodEntries.reduce((sum, entry) => sum + entry.intensity, 0) / totalEntries;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Track your emotional patterns and celebrate your mental health wins
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="p-6 bg-white/70 backdrop-blur-sm border-yellow-100">
            ...
            <div className="text-2xl font-bold text-gray-800">{Math.round((moodStats.happy / totalEntries) * 100)}%</div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-1">
                      {getIntensityDots(entry.intensity)}
                    </div>
                  </div>
                </div>
